/** Matches CURSOR_INSTRUCTIONS.md — public marketing site origin. */
...
/**
 * Turn in-app / CMS URLs into absolute marketing-site links so the header test app
 * does not navigate within localhost.
 */
...
/** Clone options and rewrite all `url` / `permalink` fields under `header` only. */
